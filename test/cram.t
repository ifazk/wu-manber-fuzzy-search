Simplest tests
  $ ../test-runners/string_tests.exe 2 "abcd" "abcd"
  k=2, p="abcd", t="abcd"
  Pattern matched with 2 errors at character 2 of text
  Pattern matched with 0 errors at character 4 of text

  $ ../test-runners/string_tests.exe 2 "abcd" "ab"
  k=2, p="abcd", t="ab"
  Pattern matched with 2 errors at character 2 of text
  Pattern matched with 2 errors at character 2 of text

  $ ../test-runners/string_tests.exe 2 "abcd" "abd"
  k=2, p="abcd", t="abd"
  Pattern matched with 2 errors at character 2 of text
  Pattern matched with 1 errors at character 3 of text

  $ ../test-runners/string_tests.exe 2 "bbaa" "aa"
  k=2, p="bbaa", t="aa"
  Pattern matched with 2 errors at character 2 of text
  Pattern matched with 2 errors at character 2 of text

  $ ../test-runners/string_tests.exe 2 "bbaa" "baa"
  k=2, p="bbaa", t="baa"
  Pattern matched with 2 errors at character 2 of text
  Pattern matched with 2 errors at character 2 of text

  $ ../test-runners/string_tests.exe 2 "bbaa" "bb"
  k=2, p="bbaa", t="bb"
  Pattern matched with 2 errors at character 2 of text
  Pattern matched with 2 errors at character 2 of text

  $ ../test-runners/string_tests.exe 2 "bbaa" "ba"
  k=2, p="bbaa", t="ba"
  Pattern matched with 2 errors at character 2 of text
  Pattern matched with 2 errors at character 2 of text

  $ ../test-runners/string_tests.exe 2 "abcd" "aeb"
  k=2, p="abcd", t="aeb"
  Could not find pattern in text
  Could not find pattern in text

  $ ../test-runners/string_tests.exe 2 "abcd" "aebd"
  k=2, p="abcd", t="aebd"
  Pattern matched with 2 errors at character 4 of text
  Pattern matched with 2 errors at character 4 of text

  $ ../test-runners/string_tests.exe 3 "abcd" "aebd"
  k=3, p="abcd", t="aebd"
...
Start with deletes
  ...
  $ ../test-runners/string_tests.exe 4 "abcdefgh" "efgh"
...
Start with subs
  ...
  $ ../test-runners/string_tests.exe 4 "abcdefgh" "iiiiefgh"
...
Start with inserts
  ...
  $ ../test-runners/string_tests.exe 4 "abcdefgh" "iiiiabcdefgh"
  k=4, p="abcdefgh", t="iiiiabcdefgh"
  Pattern matched with 4 errors at character 8 of text
  Pattern matched with 0 errors at character 12 of text

Large tests
  $ ../test-runners/string_tests.exe 2 "123456789012345678901234567890123456789012345678901234567890123" "123456789012345678901234567890123456789012345678901234567890123"
  ...
  $ ../test-runners/string_tests.exe 2 "123456789012345678901234567890123456789012345678901234567890123" "1234567890123456789012345678901234567890123456789012345678901"
  ...
  $ ../test-runners/string_tests.exe 2 "123456789012345678901234567890123456789012345678901234567890123" "12345678901234567890123456789012345678901234567890123456789abcd"
  ...
  $ ../test-runners/string_tests.exe 2 "123456789012345678901234567890123456789012345678901234567890123" "12345678901234567890123456789012345678901234567890123456789abc"
  ...
  $ ../test-runners/string_tests.exe 2 "123456789012345678901234567890123456789012345678901234567890123" "123456789012345678901234567890123456789012345678901234567890a"
  ...
  $ ../test-runners/string_tests.exe 2 "123456789012345678901234567890123456789012345678901234567890123" "1234567890123456789012345678901234567890123456789012345678901a"
  ...
  $ ../test-runners/string_tests.exe 2 "123456789012345678901234567890123456789012345678901234567890123" "12345678901234567890123456789012345678901234567890123456789012a"
  ...
  $ ../test-runners/string_tests.exe 4 "123456789012345678901234567890123456789012345678901234567890123" "12345678901234567890123456789012345678901234567890123456789012a"
...
## Subs
  $ ../test-runners/string_tests.exe 4 "123456789012345678901234567890123456789012345678901234567890123" "abcd56789012345678901234567890123456789012345678901234567890123"
...
## Inserts
  $ ../test-runners/string_tests.exe 4 "123456789012345678901234567890123456789012345678901234567890123" "abcd123456789012345678901234567890123456789012345678901234567890123"
...
## Delete
  $ ../test-runners/string_tests.exe 4 "123456789012345678901234567890123456789012345678901234567890123" "56789012345678901234567890123456789012345678901234567890123"
